...
public class DownloadService extends Service {
    ...
    public static final String ACTION_PREFIX = "com.amazonaws.mobile.downloadservice.";
    ...
    /** The prefix of all extra keys. */
    public static final String EXTRA_PREFIX = "com.amazonaws.mobile.downloadservice.";

...
public class DownloadQueueProvider extends ContentProvider {
    ...
    public static synchronized String getAuthority(final Context context) {
        if (authority == null) {
            authority = "com.com.amazonaws.mobile.downloader-" + context.getPackageName();
        }
        return authority;
    }
    ...
    public static final String ROW_MIME_TYPE =
        "vnd.android.cursor.item/vnd.com.com.amazonaws.mobile.downloader." + BASE_PATH;

    /** Our MIME type for sets of rows. */
    public static final String TABLE_MIME_TYPE =
        "vnd.android.cursor.dir/vnd.com.com.amazonaws.mobile.downloader." + BASE_PATH;
